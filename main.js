...
Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["range"])(1, 200)
    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (x) { return x % 2 === 1; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (x) { return x + x; }))
...
var AppService = /** @class */ (function () {
    function AppService(http) {
        ...
        this.setUserInfoFromLocalStorage = function () {
...
var ChatBoxComponent = /** @class */ (function () {
    ...
    ChatBoxComponent.prototype.ngOnInit = function () {
        ...
        this.userInfo = this.AppService.setUserInfoFromLocalStorage();
...
Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["range"])(1, 200)
    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (x) { return x % 2 === 1; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (x) { return x + x; }))
    .subscribe(function (x) { return console.log(x); });
    ...
    function SignupComponent(appService, router, toastr, vcr) {
        ...
        this.signupFunction = function () {
            if (!_this.firstName) {
                ...
                console.log(data);
                _this.appService.signinFunction(data).subscribe(function (apiResponse) {
                    console.log(apiResponse);
                    if (apiResponse.status === 200) {
...
module.exports = __webpack_require__(/*! C:\Users\abc\Desktop\advance\chat-app\src\main.ts */"./src/main.ts");
